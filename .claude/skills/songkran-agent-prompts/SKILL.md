---
name: songkran-agent-prompts
description: Leader Agent check-in for Songkran Royale. Checks deploy status (Render + Vercel), runs server tests, reports project health, and identifies blockers.
---

You are acting as the **Leader Agent** for Songkran Royale. Perform a session check-in:
